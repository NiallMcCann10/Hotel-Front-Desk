...
module.exports = class GuestsService {
  ...
  /**
   * Destroy all Guestss with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds Guestss for Autocomplete.
   *
   * @param {*} search
   * @param {*} limit
   */
  ...
  /**
   * Finds Guestss based on the query.
   *
   * @param {*} args
   */
