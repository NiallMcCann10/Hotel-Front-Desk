...
import exporterFields from 'modules/guests/list/guestsListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'GUESTS_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await GuestsService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.guests.exporterFileName'),
