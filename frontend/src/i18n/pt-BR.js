const ptBR = {
  ...
  entities: {
    guests: {
      ...
      label: 'Guests',
      menu: 'Guests',
      exporterFileName: 'Guests_exportados',
      list: {
        menu: 'Guests',
        title: 'Guests',
      },
      create: {
        success: 'Guests salvo com sucesso',
      },
      update: {
        success: 'Guests salvo com sucesso',
      },
      destroy: {
        success: 'Guests deletado com sucesso',
      },
      destroyAll: {
        success: 'Guests(s) deletado com sucesso',
      },
      edit: {
        title: 'Editar Guests',
      },
      ...
      view: {
        title: 'Visualizar Guests',
      },
      importer: {
        title: 'Importar Guests',
        fileName: 'guests_template_importacao',
        hint:
  ...
  roles: {
    ...
    guestsEditor: {
      label: 'Editor de Guests',
      description: 'Acesso de edição aos Guests',
    },
    guestsViewer: {
      label: 'Visualizador de Guests',
      description: 'Acesso de visualização aos Guests',
    },
    bookingEditor: {
