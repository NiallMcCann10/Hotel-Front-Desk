...
import GuestsFormModal from 'view/guests/form/GuestsFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/guests/guestsSelectors';

class GuestsAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return GuestsService.listAutocomplete(value, limit);
  };
...
export default connect(select)(GuestsAutocompleteFormItem);
