...
const schema = new FormFilterSchema([
  ...
  fields.firstName,
  fields.lastName,
  fields.arrivalDateRange,
  fields.departureDateRange,
  fields.status,
  fields.costRange,
]);
            ...
            return (
              <Form onSubmit={form.handleSubmit}>
                <Row gutter={24}>
                  ...
                  <Col md={24} lg={12}>
                    <DatePickerRangeFormItem
                      name={fields.arrivalDateRange.name}
                      label={fields.arrivalDateRange.label}
                      layout={formItemLayout}
                      showTime
                    />
                  </Col>
                  <Col md={24} lg={12}>
                    <DatePickerRangeFormItem
                      name={fields.departureDateRange.name}
                      label={fields.departureDateRange.label}
                      layout={formItemLayout}
                      showTime
                    />
                  </Col>
                  ...
                  <Col md={24} lg={12}>
                    <InputRangeFormItem
                      name={fields.costRange.name}
                      label={fields.costRange.label}
                      layout={formItemLayout}
                    />
                  </Col>
                </Row>
